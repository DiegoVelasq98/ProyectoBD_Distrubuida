...
public class frm_cliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_bitacoraworkbench = new javax.swing.JButton();
        ...
        jLabel1.setText("Base de Datos Workbench");
        ...
        btn_bitacoraworkbench.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        btn_bitacoraworkbench.setText("Bitacora Workbench");
        btn_bitacoraworkbench.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_bitacoraworkbenchActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(btn_bitacoraworkbench)
                .addGap(102, 102, 102))
            .addGroup(layout.createSequentialGroup()
                .addGap(37, 37, 37)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(txt_direccion, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(txt_telefonocasa, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)))
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txt_bonificacion, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(lbl_bonificacion, javax.swing.GroupLayout.Alignment.TRAILING))
                                .addGap(58, 58, 58)))
    ...
    private void btn_ingresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ingresarActionPerformed
        ...
        obj_cliente = new Cliente (0,txt_nit.getText(),txt_dpi.getText(), txt_nombre1.getText(), txt_nombre2.getText(), txt_apellido1.getText(), txt_apellido2.getText(), txt_direccion.getText(),txt_telefonocasa.getText(), txt_telefonomovil.getText(), txt_salario.getText(), txt_bonificacion.getText() );
        obj_cliente.agregar();
     tbl_cliente.setModel(obj_cliente.leer());
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        ...
        obj_cliente = new Cliente (Integer.valueOf(lbl_id.getText()),txt_nit.getText(),txt_dpi.getText(), txt_nombre1.getText(), txt_nombre2.getText(), txt_apellido1.getText(), txt_apellido2.getText(), txt_direccion.getText(),txt_telefonocasa.getText(), txt_telefonomovil.getText(), txt_salario.getText(), txt_bonificacion.getText() );
    ...
    private void btn_atrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_atrasActionPerformed
            ...
            JOptionPane.showMessageDialog(null, "Conexión con Workbench cerrada", "Conexión Cerrada", JOptionPane.INFORMATION_MESSAGE);

        frm_inicio fr= new frm_inicio();
        fr.setVisible (true);
        dispose();        dispose();    }//GEN-LAST:event_btn_atrasActionPerformed

    private void btn_bitacoraworkbenchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_bitacoraworkbenchActionPerformed
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_btn_bitacoraworkbenchActionPerformed
    ...
    private javax.swing.JButton btn_bitacoraworkbench;
